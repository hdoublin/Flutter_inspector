  ...
  Widget build(BuildContext context) {
   ...
   /*  final image2 =
    ...
    final bathFloor = useState(
        getStringAsync(k5SubFloor1FloorTiles, defaultValue: 'Satisfactory'));
    final bathVanity = useState(
        getStringAsync(k5SubFloor1Vanity, defaultValue: 'Satisfactory'));
    final bathShower = useState(
        getStringAsync(k5SubFloor1Shower, defaultValue: 'Satisfactory'));
    
    final bathWaste = useState(
        getStringAsync(k5SubFloor1FloorWaste, defaultValue: 'Satisfactory'));
    final bathDoor = useState(
        getStringAsync(k5SubFloor1Door, defaultValue: 'Satisfactory'));
    ...
    final noteSubFloor = useTextEditingController(
        ...
        getStringAsync(k5SubFloor1GeneralCondition, defaultValue: 'Satisfactory'));
                                        ...
                                        ListTile(
                                          ...
                                          trailing: GestureDetector(
                                            onTap: () {
                                              ...
                                              setValue(
                                                  k5SubFloor1Picture, addedString);
                                              imageChange.value = false;
                                              imageChange.value = true;
                                            },
                                            child: const Icon(
