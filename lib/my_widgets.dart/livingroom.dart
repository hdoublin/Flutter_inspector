...
class LivingRoomWidget extends HookWidget {
  LivingRoomWidget(
      {super.key,
      required this.index,
 ...
 /*    final image2 = useState(
        getStringAsync('k5Living1Picture$listValue', defaultValue: ''));
 */
 final imageChange = useState(true);
    //propery facade
    final newImageList =
        useState(getStringAsync('k5Living1Picture$listValue', defaultValue: ''));
    ...
    final bathTiles = useState(getStringAsync('k5Living1WallTiles$listValue',
        defaultValue: 'Satisfactory'));
    final bathFloor = useState(getStringAsync('k5Living1FloorTiles$listValue',
        defaultValue: 'Satisfactory'));
    final bathVanity = useState(getStringAsync('k5Living1Vanity$listValue',
        defaultValue: 'Satisfactory'));
    final bathShower = useState(getStringAsync('k5Living1Shower$listValue',
        defaultValue: 'Satisfactory'));
    final bathWaste = useState(getStringAsync('k5Living1FloorWaste$listValue',
        defaultValue: 'Satisfactory'));
    final bathDoor = useState(getStringAsync('k5Living1Door$listValue',
        defaultValue: 'Satisfactory'));
    final bathWindow = useState(getStringAsync('k5Living1Window$listValue',
        defaultValue: 'Satisfactory'));

    final noteLiving = useTextEditingController(
        text: getStringAsync('k5Living1Note$listValue', defaultValue: ''));
    return Container(
      ...
      child: Column(
        ...
        children: [
          if (index != 1)
            GestureDetector(
              onTap: () => showConfirmDialog(context, 'Delete Living $index',
          ...
          Container(
            ...
            child: DropdownButton<String>(
              ...
              onChanged: (value) {
                ...
                setValue('k5Living1WallTiles$listValue', value);
                /*  setState(() {
                      bathTiles = value;
                    }); */
              },
          ...
          Container(
            ...
            child: DropdownButton<String>(
              ...
              onChanged: (value) {
                ...
                setValue('k5Living1FloorWaste$listValue', value);
                /*  setState(() {
                      bathWaste = value;
                    }); */
              },
          ...
          Container(
            ...
            child: DropdownButton<String>(
              ...
              onChanged: (value) {
                ...
                setValue('k5Living1FloorTiles$listValue', value);
                /*  setState(() {
                      bathFloor = value;
                    }); */
              },
          ...
          Container(
            ...
            child: DropdownButton<String>(
              ...
              onChanged: (value) {
                ...
                setValue('k5Living1Vanity$listValue',
                    value); /* setState(() {
                      bathVanity = value;
                    }); */
              },
          ...
          Container(
            ...
            child: DropdownButton<String>(
              ...
              onChanged: (value) {
                ...
                setValue('k5Living1Shower$listValue', value);
                /* setState(() {
                      bathShower = value;
                    }); */
              },
       ...
       /*    const Gap(20),
          ...
          Container(
            ...
            child: DropdownButton<String>(
              ...
              onChanged: (value) {
                ...
                setValue('k5Living1Door$listValue', value);
                /*  setState(() {
                      bathDoor = value;
                    }); */
              },
          ...
          Container(
            ...
            child: DropdownButton<String>(
              ...
              onChanged: (value) {
                ...
                setValue('k5Living1Window$listValue', value);
                /* setState(() {
                      bathWindow = value;
                    }); */
              },
                ...
                GestureDetector(
                  onTap: () async {
                   /*  image2.value = await getImage() ?? '';
                    setValue('k5Living1Picture$listValue', image2.value); */
                     ...
                     List<String> path = await getImage();
                        ...
                        setValue('k5Living1Picture$listValue', addedString);
                                        ...
                                        ListTile(
                                          ...
                                          trailing: GestureDetector(
                                            onTap: () {
                                              ...
                                              setValue(
                                                  'k5Living1Picture$listValue', addedString);
                                              imageChange.value = false;
                                              imageChange.value = true;
                                            },
                                            child: const Icon(
          ...
          Container(
            ...
            child: TextFormField(
              ...
              onChanged: (value) {
                setValue('k5Living1Note$listValue', value);
              },
              validator: (value) {
                if (value!.isEmpty) {
