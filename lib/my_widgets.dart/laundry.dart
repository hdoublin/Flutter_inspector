...
class LaundryRoomWidget extends HookWidget {
  LaundryRoomWidget(
      {super.key,
      required this.index,
 ...
 */
 ...
 /*    final image2 = useState(
        getStringAsync('k5Laundry1Picture$listValue', defaultValue: ''));
 */
 final imageChange = useState(true);
  //propery facade
    final newImageList =
        useState(getStringAsync('k5Laundry1Picture$listValue', defaultValue: ''));
    ...
    final bathTiles = useState(getStringAsync('k5Laundry1WallTiles$listValue',
        defaultValue: 'Satisfactory'));
    final bathFloor = useState(getStringAsync('k5Laundry1FloorTiles$listValue',
        defaultValue: 'Satisfactory'));
    final bathVanity = useState(getStringAsync('k5Laundry1Vanity$listValue',
        defaultValue: 'Satisfactory'));
    final bathShower = useState(getStringAsync('k5Laundry1Shower$listValue',
        defaultValue: 'Satisfactory'));
    final bathWaste = useState(getStringAsync('k5Laundry1FloorWaste$listValue',
        defaultValue: 'Satisfactory'));
    final bathDoor = useState(getStringAsync('k5Laundry1Door$listValue',
        defaultValue: 'Satisfactory'));
    final bathWindow = useState(getStringAsync('k5Laundry1Window$listValue',
        defaultValue: 'Satisfactory'));

    final noteLaundry = useTextEditingController(
        text: getStringAsync('k5Laundry1Note$listValue', defaultValue: ''));
    return Container(
      ...
      child: Column(
        ...
        children: [
          if (index != 1)
            GestureDetector(
              onTap: () => showConfirmDialog(context, 'Delete Laundry $index',
          ...
          Container(
            ...
            child: DropdownButton<String>(
              ...
              onChanged: (value) {
                ...
                setValue('k5Laundry1WallTiles$listValue', value);
                /*  setState(() {
                      bathTiles = value;
                    }); */
              },
          ...
          Container(
            ...
            child: DropdownButton<String>(
              ...
              onChanged: (value) {
                ...
                setValue('k5Laundry1FloorTiles$listValue', value);
                /*  setState(() {
                      bathFloor = value;
                    }); */
              },
          ...
          Container(
            ...
            child: DropdownButton<String>(
              ...
              onChanged: (value) {
                ...
                setValue('k5Laundry1Vanity$listValue',
                    value); /* setState(() {
                      bathVanity = value;
                    }); */
              },
          ...
          Container(
            ...
            child: DropdownButton<String>(
              ...
              onChanged: (value) {
                ...
                setValue('k5Laundry1Shower$listValue', value);
                /* setState(() {
                      bathShower = value;
                    }); */
              },
          ...
          Container(
            ...
            child: DropdownButton<String>(
              ...
              onChanged: (value) {
                ...
                setValue('k5Laundry1FloorWaste$listValue', value);
                /*  setState(() {
                      bathWaste = value;
                    }); */
              },
          ...
          Container(
            ...
            child: DropdownButton<String>(
              ...
              onChanged: (value) {
                ...
                setValue('k5Laundry1Door$listValue', value);
                /*  setState(() {
                      bathDoor = value;
                    }); */
              },
          ...
          Container(
            ...
            child: DropdownButton<String>(
              ...
              onChanged: (value) {
                ...
                setValue('k5Laundry1Window$listValue', value);
                /* setState(() {
                      bathWindow = value;
                    }); */
              },
          ...
          Container(
            ...
            child: DropdownButton<String>(
              ...
              onChanged: (value) {
                bathWindow.value = value!;
                setValue('k5Laundry1Tub$listValue', value);
                /* setState(() {
                      bathWindow = value;
                    }); */
              },
                ...
                GestureDetector(
                  onTap: () async {
                   /*  image2.value = await getImage() ?? '';
                    setValue('k5Laundry1Picture$listValue', image2.value); */
                    List<String> path = await getImage();
                        ...
                        setValue('k5Laundry1Picture$listValue', addedString);
                                        ...
                                        ListTile(
                                          ...
                                          trailing: GestureDetector(
                                            onTap: () {
                                              ...
                                              setValue(
                                                  'k5Laundry1Picture$listValue', addedString);
                                              imageChange.value = false;
                                              imageChange.value = true;
                                            },
                                            child: const Icon(
          ...
          Container(
            ...
            child: TextFormField(
              ...
              onChanged: (value) {
                setValue('k5Laundry1Note$listValue', value);
              },
              validator: (value) {
                if (value!.isEmpty) {
